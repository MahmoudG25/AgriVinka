...
export const defaultAboutData = {
  hero: {
    title: "من نحن",
    description: "نحن لا نكتفي بنقل الخبر، بل نصنع الحدث. تهدف أكاديمية نماء إلى دعم المبدعين، توثيق التراث، وتعزيز الحوار الثقافي.",
  ...
  quote: {
    text: "في أكاديمية نماء، نؤمن بأن هويتنا هي بوصلتنا نحو المستقبل. نكتب بلغتنا، ونحلم بطموحنا، ونبني بأيدينا.",
    author: "فريق التحرير"
  },
  story: {
    title: "قصة أكاديمية نماء",
    content: "تأسست منصة أكاديمية نماء لتكون منارة إعلامية وثقافية تجمع شتات المبدعين العرب. انطلقنا من فكرة بسيطة: أن المحتوى العربي يستحق أن يقدم بأعلى معايير الجودة والاحترافية.\n\nفريقنا يتكون من نخبة من الكتاب، الفنانين، والمطورين الشغوفين بإبراز الوجه المشرق لحضارتنا. نسعى لبناء مجتمع تفاعلي يثري المحتوى العربي على الإنترنت.",
    image1: "",
    image2: ""
  }
};
