...
const FALLBACK_SECTIONS = [
  { title: 'المقدمة', content: 'مرحبًا بك في منصة أكاديمية نماء. باستخدامك لهذا الموقع والخدمات المرتبطة به، فإنك توافق على الالتزام بالشروط والأحكام التالية. يرجى قراءتها بعناية قبل استخدام المنصة.' },
  ...
  { title: 'الملكية الفكرية', content: 'جميع المحتويات المعروضة على المنصة — بما في ذلك الدورات والنصوص والفيديوهات والتصاميم — محمية بموجب قوانين حقوق الملكية الفكرية. لا يجوز نسخ أو توزيع أو إعادة نشر أي محتوى دون إذن كتابي مسبق من أكاديمية نماء.' },
  ...
  { title: 'تعديل الشروط', content: 'تحتفظ أكاديمية نماء بالحق في تعديل هذه الشروط في أي وقت. سيتم إبلاغ المستخدمين بأي تغييرات جوهرية عبر البريد الإلكتروني أو من خلال إشعار على المنصة. استمرار استخدام المنصة بعد التعديل يُعتبر موافقة على الشروط المحدّثة.' },
...
const TermsPage = () => {
  ...
  return (
    <>
      <SEOHead
        title="الشروط والأحكام | أكاديمية نماء"
        description="اقرأ الشروط والأحكام الكاملة لاستخدام منصة أكاديمية نماء."
