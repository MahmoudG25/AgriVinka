...
const RegisterPage = () => {
  ...
  return (
    <>
      ...
      <motion.div variants={stagger.parent} initial="initial" animate="animate" className="space-y-5">
        {/* Heading */}
        <motion.div variants={stagger.child}>
          <h2 className="text-2xl sm:text-3xl font-black text-heading-dark mb-1">أنشئ حسابك 🌱</h2>
          <p className="text-gray-500 text-sm font-medium leading-relaxed">
            انضم إلى آلاف الطلاب وابدأ رحلتك في التعليم الزراعي.
          </p>
        </motion.div>
        ...
        <motion.div variants={stagger.child} className="relative">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-3 bg-white text-gray-400 font-medium">أو سجل بالبريد الإلكتروني</span>
          </div>
        </motion.div>
        ...
        <form className="space-y-4" onSubmit={handleSubmit}>
          ...
          {/* Terms */}
          <motion.p variants={stagger.child} className="text-xs text-gray-500 font-medium">
