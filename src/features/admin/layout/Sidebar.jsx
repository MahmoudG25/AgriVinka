...
const Sidebar = ({ isOpen, onClose }) => {
  const links = [
    ...
    { label: 'تحرير الرئيسية', path: '/features/admin/home', icon: MdSettings },
    { label: 'منشئ الصفحات', path: '/features/admin/builder', icon: MdDashboardCustomize }, // New Link
    { label: 'تخصيص الهوية', path: '/features/admin/theme', icon: MdPalette }, // New Link
    ...
    { label: 'الطلبات', path: '/features/admin/orders', icon: MdPeople },
