...
const AssistantFloatingButton = () => {
  ...
  return (
    <button
      ...
      className="fixed z-[10000] bottom-[85px] md:bottom-8 right-5 h-14 w-14 md:h-16 md:w-16 bg-gradient-to-br from-primary to-accent text-white rounded-full shadow-xl hover:shadow-2xl transition-shadow flex items-center justify-center ring-2 ring-white hover:scale-105 duration-300"
